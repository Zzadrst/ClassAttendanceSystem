...
<body>
    ...
    <!-- Modal -->
<div class="modal fade" id="requestForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="requestForm" aria-hidden="true">  <div class="modal-dialog">
...
?>
        ...
        <div class="container mt-5 mb-5">
            <h3 class="text-center h-font">Hello <?php echo $_SESSION["username"]; ?>!</h3>
            ...
            ?>
            <div class="mb-3">
            <button type="button" class="btn btn-outline-success rounded-pill" data-bs-toggle="modal" data-bs-target="#presentModal">
    Present: <?php echo $presentCount; ?>
</button>

<button type="button" class="btn btn-outline-danger rounded-pill" data-bs-toggle="modal" data-bs-target="#absentModal">
    Absent: <?php echo $absentCount; ?>
</button>

<button type="button" class="btn btn-outline-warning rounded-pill" data-bs-toggle="modal" data-bs-target="#lateModal">
    Late: <?php echo $lateCount; ?>
</button>

<button type="button" class="btn btn-outline-info rounded-pill" data-bs-toggle="modal" data-bs-target="#excusedModal">
...
<!-- Modal -->
<div class="modal fade" id="presentModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="presentModalLabel" aria-hidden="true">  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Present Students</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" style="background: linear-gradient(135deg, #aedcf0, #fde3b0);">
                          <?php foreach ($presentNames as $name): ?>
                        <p><?php echo $name; ?></p>
                    <?php endforeach; ?>      </div>
      <div class="modal-footer">
      </div>
...
<!-- Modal -->
<div class="modal fade" id="absentModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="absentModalLabel" aria-hidden="true">  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Absent Students</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" style="background: linear-gradient(135deg, #aedcf0, #fde3b0);">
                    <?php foreach ($absentNames as $name): ?>
                        <p><?php echo $name; ?></p>
                    <?php endforeach; ?>      </div>
      <div class="modal-footer">
      </div>
...
<!-- Modal -->
<div class="modal fade" id="lateModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="lateModalLabel" aria-hidden="true">  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Late Students</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" style="background: linear-gradient(135deg, #aedcf0, #fde3b0);">
                    <?php foreach ($lateNames as $name): ?>
                        <p><?php echo $name; ?></p>
                    <?php endforeach; ?>      </div>
      <div class="modal-footer">
      </div>
...
<!-- Modal -->
<div class="modal fade" id="excusedModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="excusedModalLabel" aria-hidden="true">  <div class="modal-dialog">
    <div class="modal-content">
    <div class="modal-header" >
            <h1 class="modal-title fs-5" id="staticBackdropLabel">Excused Students</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body" style="background: linear-gradient(135deg, #aedcf0, #fde3b0);">
                    <?php foreach ($excusedNames as $name): ?>
                        <p><?php echo $name; ?></p>
                    <?php endforeach; ?>      </div>
      <div class="modal-footer" >
      </div>
            ...
            <?php if (empty($attendanceRecords)): ?>
                <!-- Show the request form button only if the attendance form is empty -->
...
<table class="table caption-top">
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="dropup-center dropup">
                        <select name="status[<?php echo $record['id']; ?>]" class="form-select" onchange="updateStatus(this)">
        ...
        <?php endforeach; ?>
                ...
                <button type="submit" class="btn btn-info rounded-pill">Submit Attendance</button>
            <?php endif; ?>
        </div>
    </form>
    ...
    <script>
        // Call the updateDateTime function when the document is ready
